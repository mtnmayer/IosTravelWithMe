...
class ModelSql{
    ...
    func create(){
        ...
        let res = sqlite3_exec(database, "CREATE TABLE IF NOT EXISTS POSTS (ST_ID TEXT PRIMARY KEY, TITLE TEXT,PLACE TEXT, DESCRIPTION TEXT, AVATAR TEXT)", nil, nil, &errormsg);
        if(res != 0){
